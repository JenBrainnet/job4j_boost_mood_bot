    ...
    CommandLineRunner loadDatabase(MoodRepository moodRepository,
        ...
        return args -> {
            ...
            data.add(new MoodContent(
                    ...
                    "Не волнуйтесь, всё пройдет. Попробуйте расслабиться и найти "
                            + "источник вашего беспокойства."));
            data.add(new MoodContent(
            ...
            data.add(new MoodContent(
                    ...
                    "Попробуйте успокоиться и найти причину раздражения, чтобы "
                            + "исправить ситуацию."));
            ...
            awards.add(new Award(
                    ...
                    "За 1 день хорошего настроения. "
                            ...
                            + "отправленный пользователю в качестве "
                            + "поощрения.",
                    1));
            awards.add(new Award(
                    "Настроение недели",
                    "За 7 последовательных дней хорошего "
                            + "или отличного настроения. Награда: "
                            + "Специальный значок или иконка, отображаемая "
                            + "в профиле пользователя в течение недели.",
                    7));
            awards.add(new Award(
                    "Бонусные очки",
                    "За каждые 3 дня хорошего настроения. "
                            + "Награда: Очки, которые можно обменять на "
                            + "виртуальные предметы или функции внутри приложения.",
                    3));
            awards.add(new Award(
            ...
            awards.add(new Award(
                    ...
                    "За 10 дней непрерывного хорошего настроения. "
                            + "Награда: Разблокировка новой темы оформления "
                            + "или фона в приложении.",
                    10));
            awards.add(new Award(
                    "Виртуальный подарок",
                    "После 15 дней хорошего настроения. "
                            + "Награда: Возможность отправить или "
                            + "получить виртуальный подарок внутри "
                            + "приложения.",
                    15));
            awards.add(new Award(
                    "Титул 'Лучезарный'",
                    "За 20 дней хорошего или отличного настроения. "
                            + "Награда: Специальный титул, отображаемый рядом "
                            + "с именем пользователя.",
                    20));
            awards.add(new Award(
                    "Доступ к премиум-функциям",
                    "После 30 дней хорошего настроения. "
                            + "Награда: Временный доступ к премиум-функциям "
                            + "или эксклюзивному контенту.",
                    30));
            awards.add(new Award(
                    "Участие в розыгрыше призов",
                    "За каждую неделю хорошего настроения. "
                            + "Награда: Шанс выиграть призы в ежемесячных "
                            + "розыгрышах.",
                    7));
            awards.add(new Award(
                    "Эксклюзивный контент",
                    "После 25 дней хорошего настроения. "
                            + "Награда: Доступ к эксклюзивным статьям, "
                            + "видео или мероприятиям.",
                    25));
            awards.add(new Award(
                    "Награда 'Настроение месяца'",
                    "За поддержание хорошего или отличного "
                            + "настроения в течение целого месяца. "
                            + "Награда: Специальный значок, признание "
                            + "в сообществе или дополнительные привилегии.",
                    30));
            awards.add(new Award(
                    "Физический подарок",
                    "После 60 дней хорошего настроения. "
                            + "Награда: Возможность получить небольшой "
                            + "физический подарок, например, открытку "
                            + "или фирменный сувенир.",
                    60));
            awards.add(new Award(
                    "Коучинговая сессия",
                    "После 45 дней хорошего настроения. "
                            + "Награда: Бесплатная сессия с коучем "
                            + "или консультантом для дальнейшего "
                            + "улучшения благополучия.",
                    45));
            awards.add(new Award(
                    "Разблокировка мини-игр",
                    "После 14 дней хорошего настроения. "
                            + "Награда: Доступ к развлекательным "
                            + "мини-играм внутри приложения.",
                    14));
            awards.add(new Award(
                    "Персональное поздравление",
                    "За значимые достижения "
                            + "(например, 50 дней хорошего настроения). "
